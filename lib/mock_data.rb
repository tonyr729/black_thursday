class MockData
  def items
    ...
    item_23 = Item.new({id: 23, name: "LG TV", description: "yes", unit_price: "300800", created_at: Time.now, updated_at: Time.now, merchant_id: 55})
    ...
    item_25 = Item.new({id: 25, name: "Grandma's Pumpkin Quick Bread", description: "x", unit_price: "2500", created_at: Time.now, updated_at: Time.now, merchant_id: 35})
  ...
  def merchants
    ...
    [merchant_1, merchant_2, merchant_3, merchant_4, merchant_5, merchant_6]
  end
