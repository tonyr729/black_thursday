class MockData
  ...
  def invoices
    ...
    invoice_2  = Invoice.new({:id => 2, :customer_id => 9, :merchant_id => 35, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_3  = Invoice.new({:id => 3, :customer_id => 8, :merchant_id => 35, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_4  = Invoice.new({:id => 4, :customer_id => 7, :merchant_id => 45, :status => :shipped, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_5  = Invoice.new({:id => 5, :customer_id => 6, :merchant_id => 45, :status => :shipped, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_6  = Invoice.new({:id => 6, :customer_id => 5, :merchant_id => 45, :status => :returned, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_7  = Invoice.new({:id => 7, :customer_id => 4, :merchant_id => 55, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_8  = Invoice.new({:id => 8, :customer_id => 3, :merchant_id => 55, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_9  = Invoice.new({:id => 9, :customer_id => 2, :merchant_id => 55, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_10 = Invoice.new({:id => 10, :customer_id => 1, :merchant_id => 55, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_11 = Invoice.new({:id => 11, :customer_id => 10, :merchant_id => 65, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_12 = Invoice.new({:id => 12, :customer_id => 10, :merchant_id => 65, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_13 = Invoice.new({:id => 13, :customer_id => 10, :merchant_id => 65, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_14 = Invoice.new({:id => 14, :customer_id => 10, :merchant_id => 65, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_15 = Invoice.new({:id => 15, :customer_id => 10, :merchant_id => 65, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_16 = Invoice.new({:id => 16, :customer_id => 10, :merchant_id => 75, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_17 = Invoice.new({:id => 17, :customer_id => 10, :merchant_id => 75, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_18 = Invoice.new({:id => 18, :customer_id => 10, :merchant_id => 75, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_19 = Invoice.new({:id => 19, :customer_id => 10, :merchant_id => 75, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_20 = Invoice.new({:id => 20, :customer_id => 10, :merchant_id => 75, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_21 = Invoice.new({:id => 21, :customer_id => 10, :merchant_id => 75, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_22 = Invoice.new({:id => 22, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_23 = Invoice.new({:id => 23, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_24 = Invoice.new({:id => 24, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_25 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_26 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_27 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_28 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_29 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_30 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_31 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_32 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_33 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_34 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_35 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
    invoice_36 = Invoice.new({:id => 25, :customer_id => 10, :merchant_id => 85, :status => :pending, :created_at  => Time.now, :updated_at  => Time.now})
